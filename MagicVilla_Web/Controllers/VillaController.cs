    ...
    public class VillaController : Controller
    {
        ...
        public async Task<IActionResult> CrearVilla(VillaCreateDto modelo)
        {
            ...
            {   
                ...
                if (response != null && response.IsExitoso)
                {
                    TempData["exitoso"] = "Villa Creada Exitosomante";
        ...
        public async Task<IActionResult> ActualizarVilla(VillaUpdateDto modelo)
        {
            if (ModelState.IsValid)
            {
                ...
                if (response != null && response.IsExitoso)
                {
                    TempData["exitoso"] = "Villa Actualizada Exitosomante";
                    return RedirectToAction(nameof(IndexVilla));
                }
            }
            return View(modelo);
        ...
        public async Task<IActionResult> RemoverVilla(VillaDto modelo)
        {
                ...
                if (response != null && response.IsExitoso)
                {
                TempData["exitoso"] = "Villa Eliminada Exitosomante";
                return RedirectToAction(nameof(IndexVilla));
                }

            TempData["error"] = "Ocurrio un Error al Remover Villa";
            return View(modelo);
        }
    }
}
